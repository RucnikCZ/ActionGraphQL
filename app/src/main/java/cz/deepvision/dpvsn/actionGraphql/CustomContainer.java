...
public class CustomContainer {
    ...
    public CustomContainer(SubscriptionType subscriptionType, Class<?> subscriptionClass, JsonObject variables, String subscriptionDataClassName, String graphqlQuery) {
